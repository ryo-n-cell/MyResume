...
モバイル関連企業での電波申請業務。少人数チームでのオンライン参画。  
...
大手 web 系企業でのサービス運用。少人数チームでのオンライン参画。  
既存のデータを toC 向けに公表するデータを作成するための業務アプリケーションを作成。  
...
- エビデンスが残るように、不明点はテキストで「確認」「連絡」「報告」を行う。
- 「確認」「連絡」「報告」を行う場合、指示を仰ぐ形では手間をかけさせる恐れがあるので、「～として行えばよいと思いますがいかがでしょう？」のように決断、選択をさせて認識の齟齬をすり合わせる。
- 上長の業務を補助をしていき、その仕事を任せていただいた。
- 積極的なフィードバック、改善策の提供。
...
以上の事を通し、フィードバックを行い、求める姿勢が大切だと学びました。

### チームをより良い環境をしていくために姿勢
...
- 会社利益を上げることを目的に、チーム内でスクラムを組んで PDCA・試行錯誤・フィードバックのお手伝いができるチームへ入りたいです。
- コミュニケーションを重視しているのでオフラインでの勤務を希望します(週に 2-3 日程度リモートワークは可能)
- 将来は現職では難しい、チームリーダーとして活動していければと思います
- 入社後のミスマッチも防ぎたいため、週 1 程度のインターンシップを行いたいです（時間内容などはご相談ください）
